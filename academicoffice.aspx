...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <h1>Welcome to the Academic Office</h1>
            <a href="#" class="button">Offer Courses</a>
            <a href="#" class="button">Register Students</a>
            <a href="#" class="button">Create Sections</a>
            <a href="#" class="button">Allocate Instructors</a>
            <a href="#" class="button">Generate Reports</a>
            <br /> <!-- Add a line break -->
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="admin-info">Logged in as : <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
                : <lable><textbox></textbox></lable></div>
            <h1>Welcome to the Academic Office</h1>
            <a href="#" class="button">Offer Courses</a>
            <a href="#" class="button">Register Students</a>
            <a href="#" class="button">Create Sections</a>
