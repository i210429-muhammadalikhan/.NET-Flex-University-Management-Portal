...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <asp:Label ID="lblSection" runat="server" Text="Select Section:" />
            <asp:DropDownList ID="ddlSections" runat="server" DataTextField="SectionName" DataValueField="SectionID" />
            <br /><br />
            <asp:Button ID="btnAssign" runat="server" Text="Assign Students to Section" OnClick="btnAssign_Click" />
        </div>
    </form>
</body>
</html>--%>
